...
pluralCaseList.push( {plural: "assignoperations/carAssignments", pascal: "AssignoperationCarAssignment"} )
pluralCaseList.push( {plural: "assignoperations/vehiclePerformances", pascal: "AssignoperationVehiclePerformance"} )

pluralCaseList.push( {plural: "standardmanagements/users", pascal: "StandardmanagementUser"} )
pluralCaseList.push( {plural: "standardmanagements/vehicles", pascal: "StandardmanagementVehicle"} )
