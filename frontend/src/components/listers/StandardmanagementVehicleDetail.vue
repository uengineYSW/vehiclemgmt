<template>
    <v-card outlined>
        ...
        <v-card-text>
            <VehicleStatus offline label="Status" v-model="item.status" :editMode="false" :key="false" @change="change" />
            <div>
                <String label="RegistrationNumber" v-model="item.registrationNumber" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="Make" v-model="item.make" :editMode="editMode" @change="change" />
            </div>
            <div>
            ...
            <div>
                <Number label="DriverDistance" v-model="item.driverDistance" :editMode="editMode" @change="change" />
            </div>
        </v-card-text>
