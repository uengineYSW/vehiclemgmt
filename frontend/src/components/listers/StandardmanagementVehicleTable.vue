        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <StandardmanagementVehicle :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
        ...
        data: () => ({
            ...
            headers: 
                [
                    ...
                    { text: "driverDistance", value: "driverDistance" },
                ],
            vehicle : [],
            newValue: {},
            tick : true,
